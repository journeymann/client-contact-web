 ...
 */
@Entity
@Table(name="MASTER_CLIENTGROUP")
public class ClientGroup extends AbstractMaintenance implements Serializable {

    private static final long serialVersionUID = 7851794269407495684L;

	private String client_group = null;
     ...
     * Sets code.
     */
    public void setClientGroup(String client_group) {
