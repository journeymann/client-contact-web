...
@Entity
@Table(name="ADDRESS")
public class BrokerDealerAddress implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final BrokerDealerAddress other = (BrokerDealerAddress) obj;
     ...
     * Sets list of <code>SelectionLists</code>es.
     */
    public BrokerDealerAddress addSelectionLists(SelectionLists lists2) {
