...
import com.hlpp.clientcontact.web.controller.ComplianceController;
...
/**
 * Compliance flow handler.
 *
 * @author Casmon Gordon
 */
@Component
public class ComplianceFlowHandler extends AbstractFlowHandler {
    ...
    public String handleExecutionOutcome(FlowExecutionOutcome outcome,
        ...
        return getContextRelativeUrl(ComplianceController.SEARCH_VIEW_PATH_KEY);
    }
