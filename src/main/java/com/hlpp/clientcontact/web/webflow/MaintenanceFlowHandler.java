...
import com.hlpp.clientcontact.web.controller.MaintenanceController;
...
/**
 * Maintenance flow handler.
 *
 * @author Casmon Gordon
 */
@Component
public class MaintenanceFlowHandler extends AbstractFlowHandler {
    ...
    public String handleExecutionOutcome(FlowExecutionOutcome outcome,
        ...
        return getContextRelativeUrl(MaintenanceController.SEARCH_VIEW_PATH_KEY);
    }
