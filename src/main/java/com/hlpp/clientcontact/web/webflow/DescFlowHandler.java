...
import com.hlpp.clientcontact.web.controller.DescController;
...
/**
 * Description flow handler.
 *
 * @author Casmon Gordon
 */
@Component
public class DescFlowHandler extends AbstractFlowHandler {
    ...
    public String handleExecutionOutcome(FlowExecutionOutcome outcome,
        ...
        return getContextRelativeUrl(DescController.SEARCH_VIEW_PATH_KEY);
    }
