...
import com.hlpp.clientcontact.web.controller.BrokerDealerController;
...
/**
 * BrokerDealer flow handler.
 *
 * @author Casmon Gordon
 */
@Component
public class BrokerDealerFlowHandler extends AbstractFlowHandler {
    ...
    public String handleExecutionOutcome(FlowExecutionOutcome outcome,
        ...
        return getContextRelativeUrl(BrokerDealerController.SEARCH_VIEW_PATH_KEY);
    }
